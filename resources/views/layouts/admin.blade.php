...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      FacturitaIT Corporation 
                      <small>facundomarcos@live.com.ar</small>
                    </p>
                  </li>
    ...
    <!--stack para extender el uso del script a las vistas -->
    @stack('scripts')
    <!-- Bootstrap 3.3.5 -->
    <script src="{{asset('js/bootstrap.min.js')}}"></script>
    <!--sacado de https://developer.snapappointments.com/bootstrap-select/ -->
